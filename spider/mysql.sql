...
MySQL Backup
Database: acm
Backup Time: 2024-07-05 10:14:29
*/

SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `acm`.`ac_contest`;
DROP TABLE IF EXISTS `acm`.`atcoder`;
DROP TABLE IF EXISTS `acm`.`cf_contest`;
DROP TABLE IF EXISTS `acm`.`codeforces`;
DROP TABLE IF EXISTS `acm`.`student`;
DROP VIEW IF EXISTS `acm`.`table01`;
DROP VIEW IF EXISTS `acm`.`table02`;
DROP VIEW IF EXISTS `acm`.`table03`;
...
CREATE TABLE `codeforces` (
  `cf_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
  `cf_contest` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '比赛名称',
  `cf_contest_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '比赛名称id',
  `cf_rank` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '比赛的排名',
  `cf_old_rating` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '旧积分',
  `cf_new_rating` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '最新积分',
  `cf_sum_contest` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '参与比赛的总数',
  `cf_date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '日期',
  `cf_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '序号'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

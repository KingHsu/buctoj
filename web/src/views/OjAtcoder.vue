<template>
  <div>
    ...
    <table>
      ...
      <tbody>
      <tr v-for="contest in contests" :key="contest.acContestId">
        <td>{{ contest.acContestId }}</td>
        <td>{{ contest.acContest }}</td>
        <td>{{ contest.acType }}</td>
        <td>{{ contest.acDate }}</td>
        <td>{{ contest.acTime }}</td>
        <td>{{ contest.acNum }}</td>
      </tr>
      </tbody>
    </table>
